            ...
            <div className="container mt-2 mb-5" style={{position:"relative"}}>
                ...
                <div className="container pt-3 pb-2" style={{backgroundColor:"#f5f5f5",borderRadius:"15px",boxShadow:"1px 2px 3px #aaa"}}>
                    <div style={{display:"flex",flexDirection:"row",justifyContent:"space-around"}}>
                        <button className="result resultActive w-100" id="btn12" onClick={()=>click12()}>09 am</button>
                        <button className="result w-100" id="btn6" onClick={()=>click6()}>01 pm</button>
                        <button className="result w-100" id="btn9" onClick={()=>click9()}>08 pm</button>
                    </div>
                    <hr />
