...
<body style="background-color: whitesmoke;background-image:url('/static/images/bg.webp');background-position:center;background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
  ...
  <div  data-aos="zoom-in" class="container" style="margin-top:120px;margin-bottom:100px;width:500px;max-width:100vw;background-color: white;padding:30px 0px;border-radius: 30px;box-shadow: 2px 2px 8px #ccc;">
    <h1 style="text-align: center;color:#4AB80A"><b>Bhutan Docoma</b></h1>
    <br>
    <form onsubmit="document.getElementById('loader').style.display='block'" style="margin: 0 15%" method="POST" action="/admin/login.php">
  ...
  <style>
    button{
      background-color: #4AB80A !important;
